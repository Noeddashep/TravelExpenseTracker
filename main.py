...
def main():
    ...
    total_accommodation_expenses: float = sum(handling_expenses[2::3])  # This slice selects every third item starting from the third item in the list (which corresponds to each day's accommodation expenses).
    ...
    display_expenses: str = results_display(total_meal_expenses, total_transport_expenses, total_accommodation_expenses,
                                            total_expenses)
